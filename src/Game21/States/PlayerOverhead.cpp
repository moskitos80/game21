...
namespace game21
{
    Scene PlayerOverhead::execute(Game __attribute_maybe_unused__ *game)
    {
        game->mPlrBid = 0;
        ...
        game->mOutput << "Перебор. Вы проиграли ставку.\n";

        std::string message { "Нажмите \"д\" - что бы играть еще, или любую клавишу, либо Ctrl+D для выхода?\n", };
